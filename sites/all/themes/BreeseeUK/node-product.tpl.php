...
<div class="add_steps" id="stepone">
        		<div class="sell_now_right_container"><!-----[city-login-info-cover-div-starts-here]---->
                	...
                	<div class="items_onyour"><!-----[city-login-info-1st-block-starts-here]---->
                        ...
                        <li class="normal_breesee_info"><a href="#"><?php echo t('2. images & Sort your item'); ?> </a></li>
                        <li class="normal_breesee_info"><a href="#"><?php echo t('3. Selling Info'); ?></a></li>
                        <li class="normal_breesee_info"><a href="#"><?php echo t('4. Review & Post'); ?></a></li>
                    ...
                    <div class="item_info_text_box">
                        <h1 class="add_new_product_name"><?php echo t('Product Name'); ?></h1>
					   ...
					   print drupal_render($form['title']);  ?>
                        ...
                        <div class="link_color">
                        	<span><?php echo $base_url; ?>/product/</span><span id="srurl"></span>                            </div>
                      ...
                      <?php echo t('Please choose the right option from below drop-down menu. '); ?>                       </p>
                        <?php 
			             ...
			             ?>
                        <h1 class="product_discription product_story"><?php echo t('Product Description'); ?></h1>
...
<ul id="pal_selected">
    <li class="selected_clrs" id="1" rel="<?php echo $comma_separated[0]; ?>" style="background:<?php echo $comma_separated[0]; ?>">&nbsp;</li>
                    ...
                    <div class="creator_creation">
                        <?php echo t('Creator and creation information of this item '); ?>                   </div>
                       		...
                       		<div class="creator_search_left">
                            	<ul>
                                	<li class="creator_search_leftbox">
                                    	<?php print drupal_render($form['field_buyer']); ?>                                  </li>
                    ...
                    <div class="clear"></div>
                    <div class="next_previous"><a href="javascript:void(0);" onclick="javascript:stepnext(1)"><img src="<?php print $base_url.'/'.drupal_get_path('theme', 'BreeseeUK'); ?>/images/city_store_login_sellnow02a/next_tag.jpg" border="0" /></a>                            </div>
                </div>
                    </div>
                </div>
        		...
        		<div class="sell_now_right_container"><!-----[city-login-info-cover-div-starts-here]---->
                    ...
                    <div class="breesee_login_info_blocks">
                        ...
                        <div class="product_details_original">
                            ...
                            <?php if ((arg(2) == 'edit' ) && (count($form['field_image_cache'] > 0)) ) {
														$attributes = array('id' => 'img_prev' );
														
			 print theme('imagecache', 'store_list', $form['field_image_cache'][0]['#default_value']['filepath'], $alt, $title, $attributes);  ?>
...
//                           echo drupal_render($form['taxonomy'][17]['hierarchical_select']['selects'][0]);
			                        ?>
                                </p>
                            </div>
                            <div class="star_p2">
...
//														die();
														...
														foreach($data->field_image_cache as $key => $val) { 
														if($val['view'] != '') {
														$imgurl = imagecache_create_path('product_detail_big',$val['filepath']);
														
															?>
                              <li style="display:none;"><?php  print theme('imagecache', 'product_detail_big', $imgurl);  ?></li>
                            	<li>
