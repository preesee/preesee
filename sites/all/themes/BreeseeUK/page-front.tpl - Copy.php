...
<div class="wrapper">
    <div class="header"><!-----[header-starts-here]---->
      ...
      <?php 
			...
			?>      <li class="pop"><a href="#"><b>Buy</b></a>
                		<!--<div class="slide_down">
                    	<div class="top_slide_dow"></div>
                        <div class="top_slide_middle">
                        	<a href="#">my creator shop</a>
                            <a href="#">my city store</a>
                            <a href="#">not a seller yet</a>                        </div>
                    </div>-->
                </li> 
            <!-----[pop-menu]---->
                <li class="pop"><a href="#"><b>Sell</b></a><!-----[pop-menu]---->
                	<!--<div class="slide_down">
                    	<div class="top_slide_dow"></div>
                        <div class="top_slide_middle">
                        	<a href="#">my creator shop</a>
    ...
    <?php //print $breeseemenu ?>
    <li><a class="new_button1" href="<?php print $base_url ?>/shops">SHOP</a></li>
        <li><span>&nbsp;</span></li>
        <li><a class="new_button2" href="<?php print $base_url ?>/creators">CREATORS</a></li>
        <li><span>&nbsp;</span></li>
        <li><a class="new_button3" href="<?php print $base_url ?>/cities">CITIES</a></li>
