var ajaxtooltip={
	fadeeffect: [true, 3], //enable Fade? [true/false, duration_milliseconds]
	useroffset: [10, 10], //additional x and y offset of tooltip from mouse cursor, respectively
	loadingHTML: '<div style="font-style:italic"><img src="loading.gif"/></div>',
...
jQuery(document).ready(function(){
	...
	$('.contry').each(function(index){ //find all links with "title=ajax:" declaration
