...
<div class="login_purchaising_block_cover <?php echo $order->order_status; ?>">
                        	<div class="login_purchaising_reciving_block">
                            	<div class="purchaising_reciving_sub">
                                    ...
                                    <span><h5>Transaction ID</h5></span>
                                    <span><h4><?php echo $shipment->transaction_id; ?></h4></span>
            ...
            <input type="text" id="tranid" name="tranid" readonly="readonly" value="<?php echo $shipment->transaction_id; ?>" class="reciving_adress_middle_textarea_input required" <?php echo $m ?> />
                                            </div>
                                        </span>
                                    </div>
                                	...
                                	<div class="shpping_block_input_block">
                                        ...
                                        <span>
                                        	<div class="reciving_adress_middle_textarea">
            <input type="text" readonly="readonly" value="<?php echo $shipment->shipping_method; ?>" class="reciving_adress_middle_textarea_input" <?php echo $m ?> />
                                            </div>
                                        </span>
                                    </div>
                                    <div class="shpping_block_input_block">
                                        ...
                                        <span>
                                        	<div class="reciving_adress_middle_textarea">
           <input type="text" readonly="readonly" value="<?php echo $shipment->carrier; ?>" class="reciving_adress_middle_textarea_input" <?php echo $m ?> />
                                            </div>
                                        </span>
                                    </div>
                                    ...
                                    <div class="shpping_block_input_block">
                                        ...
                                        <span>
                                        	<div class="reciving_adress_middle_textarea">
           <input type="text" readonly="readonly" value="<?php echo $shipment->tracking_number; ?>" class="reciving_adress_middle_textarea_input2" <?php echo $m ?> />
                                            </div>
                                        </span>
                                    </div>
                                    ...
                                    <div class="shpping_block_input_block">
                                        ...
                                        <span>
                                        	<div class="reciving_adress_middle_textarea">
           <input type="text" value="<?php echo $shipped;   ?>" readonly="readonly" class="reciving_adress_middle_textarea_input3"  <?php echo $m ?> />
                                            </div>
                                        </span>
                                    </div>
                             ...
                             <div class="reciving_cover_block">  
                                <div class="reciving_adress_middle_block2">
                                    <div class="shpping_block_input_block">
                                        ...
                                        <span>
                                        	<div class="reciving_adress_middle_textarea">
          <input type="text" readonly="readonly" class="reciving_adress_middle_textarea_input3" value="<?php echo $exp_del;   ?>" <?php echo $m ?> />
                                            </div>
                                        </span>
                                    </div>
                                    ...
                                    <div class="shpping_block_input_block">
                                        ...
                                        <span>
                                        	<div class="reciving_adress_middle_textarea">
                                                   <input type="text" value="<?php echo $exp_del_frm_to;  ?>" readonly="readonly" class="reciving_adress_middle_textarea_input3" <?php echo $m ?> />
                                            </div>
                                        </span>
                                    </div>  
                                </div>
                                ...
                                <?php 
																...
																if($shipment != '') {?>
                                <div class="recived_block_button">
                                	<div class="recived_block_button_left">
                                   		 <a href="javascript:void(0);">I haven't Recived</a>
                                    </div>
                                    <div class="recived_block_button_right" id="gotitdiv">
                                    	<a href="javascript:void(0);" id="igotit" rel="<?php echo $shipment->order_id; ?>">I have Recived</a>
                                    </div>
                                    <div class="recived_block_button_caution">
                                    	<p>
                                        	Do not press button " i have recived " if you have<br> not recived your purchased item .
                                            You can click<br>
                                            close
                                            	<img src="<?php echo $base_url.'/sites/all/themes/BreeseeUK/images/Reader-LoginPurchase02b/LoginPurchase02b_close_button.png'; ?>">
                           	...
                           	<div class="reciving_note_block">
                            	<div class="reciving_note_left closebtn"><img src="<?php echo $base_url.'/sites/all/themes/BreeseeUK/images/Reader-LoginPurchase02/LoginPurchase02-note.png'; ?>"></div>
...
<?php } 
if(($order->order_status == 'feedback') || ($order->order_status == 'feedbackbuyer')) { 
?>
...
<div class="login_purchase_feedback_block">
                            ...
                            <?php print drupal_get_form('breesee_purchase_feedback_form', 2);  ?>
...
<?php } 
if($order->order_status == 'feedbackseller') {  ?>

<h2>Awaiting seller feedbak.</h2>
