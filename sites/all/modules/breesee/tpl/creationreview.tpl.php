...
//$strinfo = content_profile_load('creation', $data->uid);
...
<div class="sell_now_right_container"><!-----[city-login-info-cover-div-starts-here]---->
    ...
    <div class="items_onyour"><!-----[city-login-info-1st-block-starts-here]---->
        <ul class="breesee_item_info"><!-----[city-login-info-status-manu-starts-here]---->
            ...
            <li class="active_breesee_info2"><a href="#">2. Review & Post</a></li>
        ...
        <div class="review_finish_btn">
            ...
            <div class="next_previous_cover">
                <div class="finish_previous">
                    ...
                    <a href="<?php print $base_url.'/publishCreation/'.$data->nid ?>" class="submitme"><img src="<?php print $base_url.'/'.drupal_get_path('theme', 'BreeseeUK'); ?>/images/city_store_login_sellnow04a/finish_btn.jpg" /></a>
                </div>
            </div>
        </div>
...
<!--                </div>-->
            ...
            <div class="product_slider">
                ...
                <?php if (count($data->field_upload) >= 2) { ?>
                    <ul class="thumbnail_product">
                        <?php foreach($data->field_upload as $key => $val) {
...
<!--                    </div>-->
                    ...
                    <div class="tag_type_block">
                        <?php echo BreeseeUK_taxonomy_links($data, '23'); ?>
                    </div>
...
<!--                    </div>-->
                ...
                <div class="right_block_tags edit_product_position">
                    ...
                    <div class="tag_material">
                        <?php echo $data->field_creationmaterials[0]['value']; ?>
                    </div>
                </div>
            ...
            <div class="need_checkout">
                <div class="product_checkout_lisiting">
                    ...
                    <div class="producted_selected"><!-----[place-01]---->
                        <?php  print theme('imagecache', 'store_list', $data->field_upload[0]['filepath']);  ?>
                        <div class="place_name_red"><?php  print ucfirst(_breesee_get_cityname($data->uid, 'creation')); ?></div>
                        <h1 class="itemintro"><?php echo $data->title; ?></h1>
                        <p><?php echo $data->field_surcr[0]['value']; ?></p>
                    </div><!-----[place-01]---->
                </div>
