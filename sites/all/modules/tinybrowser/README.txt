...
Currently, this module works with TinyMCE and FCKeditor. To use these editors, you also need to install and set up editor support module for Drupal (which are either one of TinyTinyMCE module, FCKeditor module or Wysiwyg module). 
...
First of all, if you wish to use TinyBrowser with a WYSIWYG editor, you need to have either TinyMCE editor or FCKeditor installed and configured. As I explained in the earlier section of this document, there are several cases of using a WYSIWYG editor. We do not explain the installation of editors and editor modules here. Please refer to the proper document of editors and editor modules for more details.
 ...
 NOTE: At this moment, CKEditor is not supported. 
...
First thing you should do is to select a WYSIWYG editor you wish to use. TinyBrowser checks the installation of editors and editor modules and try to automatically detect the one to be used and choose it as default. If you do not use any WYSIWYG editors, just leave this selection 'none'. 
...
Case-5: Use with no WYSIWYG editor (with plain textarea)
